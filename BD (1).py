...
def fuckx():
	...
	ufff = "[FBAN/FB4A;FBAV/"+str(random.randint(10,100))+'.0.0.'+str(random.randint(4000,5000))+";FBBV/"+str(random.randint(4000000,5000000))+f";[FBAN/FB4A;FBAV/420.0.0.32.61;FBBV/443010639;FBDM/"+"{density=2.0,width=720,height=1456}"+f";FBLC/en_US;FBRV/442410873;FBCR/Airtel;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/{model};FBSV/5.1.1;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]"
	return ufff
#──────────────{ LOGO }──────────────#
logo = f"""
